...
# .env
USERNAME="username"
DATABASE_URL="postgres://${USERNAME}@192.168.1.100/my_database"
```
```js
// index.js
...
```ini
# .env
DATABASE_URL="postgres://$(whoami)@192.168.1.100/my_database"
```
```js
// index.js
console.log('DATABASE_URL', process.env.DATABASE_URL)
...
DATABASE_URL postgres://yourusername@192.168.1.100/my_database
```
